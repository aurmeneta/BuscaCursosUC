...
function buscarSigla(periodo, sigla, url = undefined) {
    if (!url) {
...
function buscarProfesor(periodo, profesor, cors = false, url = undefined) {
    if (!url) {
...
function buscarCurso(periodo, nombre, cors = false, url = undefined) {
    if (!url) {
